          ...
          <View>
            ...
            <View style={styles.actionRow}>
              ...
              <TouchableOpacity
                ...
                onPress={refresh}
              >
                <Text style={[styles.actionBtnText, { color: '#131b2e' }]}>
                  ↻ Refresh
                </Text>
              </TouchableOpacity>
            </View>
...
const styles = StyleSheet.create({
  ...
  sectionNav: {
    ...
    borderBottomWidth: 1,
    borderBottomColor: '#c2c6d6',
  },
  sectionBtn: { flex: 1, paddingVertical: 8, alignItems: 'center' },
  sectionBtnActive: { borderBottomWidth: 2, borderBottomColor: '#0058be' },
  sectionBtnText: { color: '#9da3b0', fontSize: 10, fontWeight: '600' },
  sectionBtnTextActive: { color: '#0058be' },
  // Titles
  sectionTitle: {
    color: '#0058be',
    fontWeight: '700',
  ...
  alertItem: { color: '#856404', fontSize: 11 },
  // Action buttons
  actionRow: {
    flexDirection: 'row',
    paddingHorizontal: 12,
  ...
  btnReset: { backgroundColor: '#38a169' },
  btnSecondary: { backgroundColor: '#e8eaff' },
  btnPrimary: {
  ...
  handoffCard: { borderColor: '#9da3b0' },
  scenarioCard: { borderColor: '#9da3b0', borderStyle: 'dashed' },
  ...
  receiptHint: { color: '#38a169', fontSize: 9, marginTop: 2 },
  // Rendezvous result
  resultCard: {
  ...
  errorBox: { backgroundColor: '#fce4ec', borderRadius: 6, padding: 8 },
  errorText: { color: '#93000a', fontSize: 11 },
  bestBox: {
    backgroundColor: '#f2f3ff',
    borderRadius: 8,
    padding: 10,
  ...
  etaBoxHighlight: { backgroundColor: '#e0ecff' },
  etaLabel: { color: '#565e74', fontSize: 9, marginBottom: 2 },
  etaValue: { color: '#131b2e', fontSize: 14, fontWeight: '700' },
  candidatesHeader: { color: '#565e74', fontSize: 10, marginBottom: 4 },
  candidateRow: {
    color: '#131b2e',
    fontSize: 10,
    fontFamily: 'monospace',
  ...
  throttleRule: { color: '#565e74', fontSize: 10, marginBottom: 2 },
  ...
  simStatHighlight: { backgroundColor: '#d4edda', borderRadius: 6, padding: 4 },
  simStatNum: { color: '#131b2e', fontSize: 18, fontWeight: '700' },
  simStatLabel: { color: '#565e74', fontSize: 9 },
  tableHeader: {
    flexDirection: 'row',
    borderBottomWidth: 1,
    borderBottomColor: '#c2c6d6',
  ...
  tableCellHdr: { color: '#565e74', fontWeight: '700' },
  tableRow: { flexDirection: 'row', paddingVertical: 3 },
  tableRowHighlight: { backgroundColor: '#e8f5e9' },
  tableCell: { color: '#131b2e', fontSize: 10, fontFamily: 'monospace' },
  bottomPad: { height: 24 },
});
